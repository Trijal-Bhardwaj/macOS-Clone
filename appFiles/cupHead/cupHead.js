  ...
  startBtn.addEventListener("click", function () {
    ...
    setInterval(() => {
      ...
      img.addEventListener("click", function () {
        ...
        if (cpHeadScore == 1) {
          scoreImgCp.src =
            "https://fontmeme.com/permalink/210823/ccdf8a623f46ddda4b5910397bdc9392.png";
        } else if (cpHeadScore == 2) {
          scoreImgCp.src =
            "https://fontmeme.com/permalink/210823/d6d9281d82671061cfdfe6ec0148ebdb.png";
        } else if (cpHeadScore == 3) {
          scoreImgCp.src =
            "https://fontmeme.com/permalink/210823/cb9db5f54586874a3c87b78ddc9063ea.png";
        } else if (cpHeadScore == 4) {
          scoreImgCp.src =
            "https://fontmeme.com/permalink/210823/7caf553ad60c09bed9c860e1cf617d3f.png";
        } else if (cpHeadScore == 5) {
          scoreImgCp.src =
            "https://fontmeme.com/permalink/210823/f42fdd22c91b759630aa487b3ce99dc0.png";
        } else if (cpHeadScore == 6) {
          scoreImgCp.src =
            "https://fontmeme.com/permalink/210823/ff9119b59a22839d318ae09aee5a49c6.png";
        } else if (cpHeadScore == 7) {
          scoreImgCp.src =
            "https://fontmeme.com/permalink/210823/7aab691511f0ade32fbd22539d855261.png";
        } else if (cpHeadScore == 8) {
          scoreImgCp.src =
            "https://fontmeme.com/permalink/210823/9c7022a19097f6d91c87f12afd524a6b.png";
        } else if (cpHeadScore == 9) {
          scoreImgCp.src =
            "https://fontmeme.com/permalink/210823/67f6b31f15998cbf11d0c9c80687c444.png";
        } else if (cpHeadScore == 10) {
          scoreImgCp.src =
            "https://fontmeme.com/permalink/210823/11325b323d86ae9f2acb527bc26a22ae.png";

          setTimeout(() => {
            let cupHeadAppSiteBox = document.querySelector(
              ".cupHead-appSiteBox"
            );
            cupHeadAppSiteBox.innerHTML = `
