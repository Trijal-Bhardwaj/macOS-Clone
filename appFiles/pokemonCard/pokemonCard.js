...
function pokemonCard(currDockIcon) {
  ...
  playHouse.addEventListener("click", function () {
    let pokemonCardAppSiteBox = document.querySelector(
      ".pokemonCard-appSiteBox"
    );
    pokemonCardAppSiteBox.style.backgroundImage =
      "url('./appFiles/pokemonCard/pokemonCardImage/playMode.jpg')";
    ...
    setInterval(() => {
      if (
        lehaBoxImg.getAttribute("src") ==
        "../../appFiles/pokemonCard/pokemonCardImage/Leah1.png"
      ) {
        lehaBoxImg.setAttribute(
          "src",
          "../../appFiles/pokemonCard/pokemonCardImage/Leah2.png"
        );
      } else {
        lehaBoxImg.setAttribute(
          "src",
  ...
  if (first_id != k) {
    if (first == 0) {
      ...
      if (first == imgNo) {
        ...
        let imgBox1 = document
          .getElementById(`${first_id}`)
          .removeAttribute("onClick");
        let imgBox2 = document
          .getElementById(`${k}`)
          .removeAttribute("onClick");
