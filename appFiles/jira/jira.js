...
function jiraApp(currDockIcon) {
                ...
                <div class="grid">
                            <div class="leftMenu">
                                <div class="teamNSpaceArea">
                                    ...
                                    <div class="nameSpaceBox-text" >Trijal Bhardwaj</div>
                            </div>
                        </div>
  ...
  createBox.addEventListener("click", function () {
    ...
    let tamaramaModalBOx = document.querySelector(
      ".modalColorBox.jiraTamarama"
    );
    ...
    modalContentBox.addEventListener("keypress", function (e) {
      if (e.key == "Enter") {
        ...
        let jirarightContentBox = document.querySelector(
          ".jira-right-Content-Box"
        );
        let div = document.createElement("div");
        ...
        let singleBoxColorChange = document.querySelector(
          `[jiranoteid="${id}"]`
        );
        if (singleBoxColorChange) {
          singleBoxColorChange.addEventListener("click", function (e) {
            ...
            singleBoxColorChange.classList.add(
              `jira${colorArr[(currColorIndex + 1) % 4]}Box`
            );
  ...
  let quickFilterYellow = document.querySelector(
    ".JRT-innerColorBox.jiraYellow"
  );
  ...
  let quickFilterTamarama = document.querySelector(
    ".JRT-innerColorBox.jiraTamarama"
  );
