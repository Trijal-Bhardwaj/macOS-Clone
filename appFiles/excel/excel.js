...
function excelApp(currDockIcon) {
  ...
  for (let i = 1; i <= 100; i++) {
    ...
    for (let j = 0; j < 26; j++) {
      ...
      let formulaBarSelectedArea = document.querySelector(
        ".excel-selected-cell-div"
      );
      columnCell.addEventListener("click", function (e) {
        ...
        let columnAdd = currAddressCell.replace(
          currAddressCell.match(/\d+/)[0],
          ""
        );
        ...
        let alignListNew = document.querySelectorAll(
          ".optionInnerBarTextAlignBox span"
        );
        ...
        //BOx-Style
        let textBoxStyle = document.querySelectorAll(
          ".optionInnerBarTextBox span"
        );
        ...
        let textFontSizeBar = document.querySelector(
          ".optionInnerBarFontSizeBox"
        );
        ...
        let colorOption = document.querySelectorAll(
          ".optionInnerBarColorBox span"
        );
  ...
  let blankColumnContainerScroll = document.querySelector(
    ".excel-blank-column-container"
  );
  ...
  lineThrough.addEventListener("click", function () {
    if (lastCell) {
      ...
      if (lastCell && currObjTextBoxStyleValue.includes("lineThrough")) {
        ...
        lastCell &&
        !currObjTextBoxStyleValue.includes("lineThrough")
      ) {
  ...
  file.addEventListener("click", function () {
    ...
    if (document.querySelector(".fileM")) {
      ...
      document
        .querySelector(".fileM")
        .parentNode.removeChild(document.querySelector(".fileM"));
      return;
    }
